...
| [`docs/deck/`](docs/deck/) | **The complete build guide as a printable book** — 98 pages, 33 diagrams: every step, every click, every line of code, what the output should look like, and how each part connects to the others |
